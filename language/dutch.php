...
$languages['dutch'] = array (
    ...
    "error_devid" => "Onjuist apparaatadresformaat",
    "error_devtype" => "Onjuist apparaatadrestypeformaat",
    ...
    "table_devid" => "Apparaatadres",
    "table_devtype" => "Apparaatadrestype",
