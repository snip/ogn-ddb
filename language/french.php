...
$languages['french'] = array (
    ...
    "error_devid" => "Format d'adresse radio incorrect",
    "error_devtype" => "Format du type d'adresse radio incorrect",
    ...
    "table_devid" => "Adresse radio",
    "table_devtype" => "Type d'adresse radio",
