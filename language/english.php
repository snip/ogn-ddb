...
$languages['english'] = array (
    ...
    "error_pwtooshort" => "Password is too short (4 char min)",
    "error_emailformat" => "Invalid email address format",
    "error_userexists" => "This user already exists",
    "error_userdoesnotexists" => "This user does not exist",
    "error_insert_tmpusers" => "Database error, please retry later",
    "error_validation" => "Error validating your address, is it already validated?",
    "error_nodevice" => "No device recorded for this account",
    "error_devid" => "Incorrect device address format",
    "error_devtype" => "Incorrect device address type format",
    ...
    "email_sent" => "An email has just been sent to you.  Inside you'll find instructions on how to validate your account.",
    ...
    "table_devid" => "Device address",
    "table_devtype" => "Device address type",
    ...
    "table_delete" => "Delete",
    "table_new" => "Add new",
    "table_tt_expiration" => "This device registration is going to expire on:",
    "expiry_disclaimer" => "Devices with expired registrations are free to be registered by other users. To renew an expired device for another year, edit and validate your device, review the data, check the device ownership certification checkbox and press submit.",
    "expiry_warning" => "Warning: Some of your device registrations are EXPIRED, please review them.",
